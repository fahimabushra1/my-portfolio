...
const About = () => {
    return (
        <div id="about" className="bg-yellow-500 font-bold p-4">
            <div className="text-wrap w-1/2 bg-[url('assets/images/bg-4.png')]">
            <h2 className="font-bold text-4xl text-left mb-4">About Me</h2>
